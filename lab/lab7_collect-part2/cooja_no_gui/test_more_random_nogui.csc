...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>1.4136741005409583</x>
        <y>-7.10430942239496</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>24.435212381550453</x>
        <y>66.24573176821607</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.5068507718828936 0.0 0.0 2.5068507718828936 41.55496763089166 45.647827397609596</viewport>
    </plugin_config>
    <width>368</width>
    <z>2</z>
    <height>449</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>SIM_SETTLING_TIME = 1000
        ...
        outputs = new FileWriter("test_more_random_nogui.log");
        dcoutputs = new FileWriter("test_more_random_nogui_dc.log");
